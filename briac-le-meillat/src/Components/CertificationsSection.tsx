...
import certif1 from '../assets/certifications/certification-python-essential-1-from-cisco.png';
import certif2 from '../assets/certifications/certification-python-essential-2-from-cisco.png';
        ...
        <div className="w-full flex items-center justify-center py-20 pointer-events-auto">
            <GlassCard className="w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full px-4">
                    <CertificationCard imageUrl={certif1} />
                    <CertificationCard imageUrl={certif2} />
                    <CertificationCard imageUrl={certif2} />
                </div>
            </GlassCard>
        </div>
