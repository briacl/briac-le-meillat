        ...
        <div className="w-full flex items-center justify-center py-20 pointer-events-auto">
            <GlassCard className="w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full px-4">
                    <CertificationCard imageUrl="/assets/certification-python-essential-1-from-cisco.png" />
                    <CertificationCard imageUrl="/assets/certification-python-essential-2-from-cisco.png" />
                    <CertificationCard imageUrl="/assets/certification-python-essential-2-from-cisco.png" />
                </div>
            </GlassCard>
        </div>
