...
const pillars: Pillar[] = [
    ...
    },
    {
        id: 'visualisation',
        label: 'Pilier II',
        title: 'Visualisation & Outils',
        tagline: 'Rendre l\'invisible lisible.',
        description: 'Construire des outils pour mieux comprendre ce qu\'on ne voit pas.',
        projects: ['machine-learning', 'visualisation-réseau'],
        projectTaglines: [
            'Voir le réseau autrement.',
            'Des modèles qui apprennent.',
        ],
