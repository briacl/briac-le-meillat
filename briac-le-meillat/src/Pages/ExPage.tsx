                ...
                >
                    {loading ? (
                        ...
                        <div className="prose-container bg-white text-slate-900 border border-slate-200/60 shadow-sm rounded-3xl p-6 md:p-12 my-2">
                            ...
                            {/* Schema Topologie (Optionnel) */}
                            {metadata?.schema_image && (
                                <div className="mb-10 mt-2">
                                    <h3 className="text-[11px] font-bold uppercase tracking-[0.2em] text-slate-400 mb-4 font-sans flex items-center gap-2">
                                        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
