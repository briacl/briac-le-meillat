...
export default function LandingPage() {
    ...
    // Neural Network Animation properties based on exploration progress
        ...
        <div className="relative w-full min-h-screen font-sans text-skin-text-main bg-skin-base transition-colors duration-500">
            ...
            <div className="relative z-10 flex flex-col items-center w-full pointer-events-none">
                ...
                <div className="w-[95%] max-w-[1920px] mx-auto flex flex-col gap-0 mb-16">
                    ...
                    {/* MANIFESTO SECTION (Vision Phase) */}
                    ...
                    <div className="pointer-events-auto w-full z-10 bg-black/50 backdrop-blur-sm pt-20">
                        <BentoSkills />
                    </div>

                    {/* ATELIER SECTION (Project Showcase) */}
                    <div className="pointer-events-auto w-full z-10">
                        <ProjectShowcase />
                    </div>

                    {/* CONTACT SECTION */}
                    <div id="contact-section" className="min-h-[50vh] flex items-center justify-center pointer-events-auto w-full z-10 bg-black/50 py-32 backdrop-blur-sm">
                        <ContactForm />
                    </div>
