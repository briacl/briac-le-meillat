 ...
 */
export default function LandingPageOldOld() {
    useEffect(() => {
        ...
        <div className="relative w-full min-h-screen font-sans bg-black selection:bg-blue-500 overflow-x-hidden">
            ...
            <main className="relative w-full">
                ...
                <div className="relative z-10 bg-black">
                    ...
                    {/* 5. PURE STRUCTURE — commenté temporairement pour restructuration */}
                ...
                <div id="the-ecosystem" className="relative z-10 bg-black text-white min-h-screen">
                    ...
                    {/* 9. CODE POETICS & LOGIC AS CANVAS — commentés pour restructuration */}
                    {/* <CodePoetics />
                    <LogicAsCanvas /> */}
